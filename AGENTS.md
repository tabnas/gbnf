...
| [`docs/`](docs/) | The GitHub Pages site (`docs/index.html`), aimed at AI developers. One self-contained file, no external requests, tabnas palette — matching [tabnas.github.io/chess](https://tabnas.github.io/chess/). Every code sample on it was run before publication. |
