...
//
// gbnf TEXT IN, VERDICT (AND VALUE) OUT. This is one of the
...
// tabnas_grammar builds a gbnf parser and returns a handle to it.
...
// tabnas_parse checks one input against the gbnf grammar.
//
//export tabnas_parse
