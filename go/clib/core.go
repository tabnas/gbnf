...
//
// libtabnasgbnf is the gbnf format parser as a C shared library, one of
...
// newParser builds one engine with the gbnf grammar installed
...
// parseWith answers whether src is in the gbnf language — and,
